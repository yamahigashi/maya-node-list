...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/polyPlatonicSolid.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_value">None</br>Normalization Off</br>Normalize Each Face Separately</br>Normalize Collectively</br>Normalize Collectively and Preserve Aspect Ratio (3)</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>sideLength (l)</h5></td>
                <td class="attr_type">doubleLinear</td>
                <td class="attr_value">0.713699996471 ()</td>
                <td class="attr_minmax">0.01/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'keyable']</td>
            </tr>
            ...
            <tr class="indent0">
                ...
                <td class="attr_type">enum</td>
                <td class="attr_value">Dodecahedron</br>Icosahedron</br>Octahedron</br>Tetrahedron ()</td>
