...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/hwReflectionMap.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>cubeBackTextureName (cbkn)</h5></td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>cubeBottomTextureName (cbmn)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>cubeFrontTextureName (cftn)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>cubeLeftTextureName (cltn)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>cubeMap (cm)</h5></td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>cubeRightTextureName (crtn)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>cubeTopTextureName (ctpn)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>decalMode (dm)</h5></td>
                <td class="attr_type">bool</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>sphereMapTextureName (smtn)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>textureHasChanged (thc)</h5></td>
                <td class="attr_type">bool</td>
                <td class="attr_value">False ()</td>
                <td class="attr_minmax">0/1</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'hidden']</td>
