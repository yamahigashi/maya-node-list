.. index::
    single: nodeGraphEditorBookmarkInfo
    single: 0x4e454249

_default - nodeGraphEditorBookmarkInfo (0x4e454249)
=======================================================================================================================================
...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/nodeGraphEditorBookmarkInfo.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="parent indent0 dotted">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>nodeInfo (ni)</h5></td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>name (nm)</h5></td>
            ...
            <tr class="parent indent0 dotted">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>viewRectHigh (vh)</h5></td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>viewXH (xh)</h5></td>
            ...
            <tr class="child indent1 last">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>viewYH (yh)</h5></td>
                <td class="attr_type">double</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'hidden']</td>
            ...
            <tr class="parent indent0 dotted">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>viewRectLow (vl)</h5></td>
                <td class="attr_type">double2</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'hidden']</td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>viewXL (xl)</h5></td>
                <td class="attr_type">double</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'hidden']</td>
            ...
            <tr class="child indent1 last">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>viewYL (yl)</h5></td>
                <td class="attr_type">double</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'hidden']</td>
