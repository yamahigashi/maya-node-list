...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/polySubdFace.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>divisionsU (duv)</h5></td>
                <td class="attr_type">long</td>
                <td class="attr_value">1.0 (1)</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>divisionsV (dvv)</h5></td>
                <td class="attr_type">long</td>
                <td class="attr_value">1.0 (1)</td>
                <td class="attr_minmax">1/250</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'keyable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>mode (m)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">quads</br>triangles ()</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>subdMethod (sbm)</h5></td>
                <td class="attr_type">enum</td>
