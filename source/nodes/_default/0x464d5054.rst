...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/tweak.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="parent indent0 dotted">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>plist (pl)</h5></td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>controlPoints (cp)</h5></td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>zValue (zv)</h5></td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>xValue (xv)</h5></td>
                <td class="attr_type">doubleLinear</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'keyable']</td>
            ...
            <tr class="child indent2 last">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>yValue (yv)</h5></td>
                <td class="attr_type">doubleLinear</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'keyable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>relativeTweak (rtw)</h5></td>
                <td class="attr_type">bool</td>
            ...
            <tr class="parent indent0 dotted">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>vlist (vl)</h5></td>
                <td class="attr_type">compound</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'array']</td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>vertex (vt)</h5></td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>yVertex (vy)</h5></td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>zVertex (vz)</h5></td>
                <td class="attr_type">floatLinear</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'keyable']</td>
            ...
            <tr class="child indent2 last">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>xVertex (vx)</h5></td>
                <td class="attr_type">floatLinear</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'keyable']</td>
