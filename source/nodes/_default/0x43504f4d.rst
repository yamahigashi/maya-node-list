...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/closestPointOnMesh.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>closestVertexIndex (vt)</h5></td>
            ...
            <tr class="child indent1 last">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>closestFaceIndex (f)</h5></td>
                <td class="attr_type">long</td>
                <td class="attr_value">-1.0 (true)</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'out']</td>
