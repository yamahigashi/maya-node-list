...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/polyEdgeToCurve.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>degree (dg)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">1=1</br>2</br>3</br>5=5</br>7=7 (3)</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>form (f)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">Open</br>Periodic</br>Best guess (2)</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>inputPolymesh (ipm)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
