...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/orientConstraint.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>interpType (int)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">No Flip</br>Average</br>Shortest</br>Longest</br>Cache (1)</td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>targetRotateCached (ctr)</h5></td>
                <td class="attr_type">double3</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>targetRotateCachedZ (ctrz)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out']</td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>targetRotateCachedY (ctry)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out']</td>
            ...
            <tr class="child indent2 last">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>targetRotateCachedX (ctrx)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out']</td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>targetJointOrientX (tjox)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>targetJointOrientY (tjoy)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent2 last">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>targetJointOrientZ (tjoz)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>interpCache (inc)</h5></td>
                <td class="attr_type">long</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="parent indent0 dotted">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>lastTargetRotate (lr)</h5></td>
                <td class="attr_type">double3</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>lastTargetRotateZ (lrz)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>lastTargetRotateY (lry)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent1 last">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>lastTargetRotateX (lrx)</h5></td>
                <td class="attr_type">doubleAngle</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
