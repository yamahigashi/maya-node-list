...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/polyAppend.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_value">none</br>normalized</br>unitized ()</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>test2EdgeLoops (tel)</h5></td>
                <td class="attr_type">bool</td>
