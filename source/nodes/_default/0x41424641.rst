...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/animBlendNodeAdditiveFA.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>interpolateMode (im)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">additive</br>multiply ()</td>
