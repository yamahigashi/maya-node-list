...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/polyPlane.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_value">None</br>Normalization Off</br>Normalize and Preserve Aspect Ratio (1)</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_type">enum</td>
                <td class="attr_value">none</br>Stretch to fit</br>Preserve Aspect Ratio (1)</td>
                <td class="attr_minmax">0/2</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            </tr>
