.. index::
    single: filterResample
    single: 0x464c5452

_default - filterResample (0x464c5452)
=======================================================================================================================================
...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/filterResample.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>kernel (kr)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">Pass Through=100</br>Closest Sample=200</br>Linear Interpolation=300</br>Box Filter=400</br>Tent Filter=500</br>Gaussian 1/sqrt(2)=600</br>Gaussian 1/2=700 (600)</td>
                <td class="attr_minmax">100/700</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            </tr>
