...
nearestPointOnMesh.mll - nearestPointOnMesh (0x81028L)
=======================================================================================================================================
...
:plugin:
    C:/Program Files/Autodesk/Maya2017/bin/plug-ins/nearestPointOnMesh.mll
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>inMesh (im)</h5></td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>nearestFaceIndex (f)</h5></td>
                <td class="attr_type">long</td>
                <td class="attr_value">509.0 (true)</td>
                <td class="attr_minmax">/</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_type">double</td>
                <td class="attr_value">7.1016562043e-26 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'out']</td>
            </tr>
            ...
            <tr class="indent0">
                ...
                <td class="attr_type">double</td>
                <td class="attr_value">3.08285662151e-44 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'out']</td>
            </tr>
