    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>correlation (cl)</h5></td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>frequency (fy)</h5></td>
                <td class="attr_type">float</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>live (lv)</h5></td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>preserveLength (pl)</h5></td>
                <td class="attr_type">float</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">0/100</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'keyable']</td>
