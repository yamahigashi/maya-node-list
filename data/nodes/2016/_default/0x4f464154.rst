...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/objectAttrFilter.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>attrType (atyp)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">All</br>Writable</br>Readable</br>Keyable</br>Scale Rotate Translate</br>With Expressions</br>With Animation Curves</br>Dynamic</br>Hidden</br>Published</br>With Driven Keys (1)</td>
