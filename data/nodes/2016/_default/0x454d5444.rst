...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/editMetadata.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="parent indent0 dotted">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>edits (e)</h5></td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>channelEdits (ce)</h5></td>
                <td class="attr_type">compound</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'array']</td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>streamName (sn)</h5></td>
            ...
            <tr class="child indent2 dotted">
                ...
                <td class="attr_name" style="text-indent: 8ex;"><h5>streamEdits (se)</h5></td>
                <td class="attr_type">compound</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'array']</td>
            ...
            <tr class="child indent3 dotted">
                ...
                <td class="attr_name" style="text-indent: 12ex;"><h5>metadataMember (mm)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent3 dotted">
                ...
                <td class="attr_name" style="text-indent: 12ex;"><h5>metadataIndexValue (miv)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent3 dotted">
                ...
                <td class="attr_name" style="text-indent: 12ex;"><h5>metadataEditType (met)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">set</br>delete</br>reindex ()</td>
            ...
            <tr class="child indent3 dotted">
                ...
                <td class="attr_name" style="text-indent: 12ex;"><h5>metadataEditValue (mev)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent3 last">
                ...
                <td class="attr_name" style="text-indent: 12ex;"><h5>error (err)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent1 last">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>channelName (cn)</h5></td>
                <td class="attr_type"></td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>inData (id)</h5></td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>outData (od)</h5></td>
                <td class="attr_type">typed</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
