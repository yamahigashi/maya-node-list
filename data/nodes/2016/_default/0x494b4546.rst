...
.. _a link: http://help.autodesk.com/cloudhelp/2016/ENU/Maya-Tech-Docs/Nodes/hikIKEffector.html
    ...
    <table class="attribute">
        <tbody>
            ...
            <tr class="indent0">
                ...
                <td class="attr_value">None</br>Circle</br>Square</br>Cube</br>Sphere</br>Hard Cross</br>Light Cross (4)</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>pinR (pinr)</h5></td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>pinning (pin)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">unpinned</br>pinTranslate</br>pinRotate</br>pinAll ()</td>
            ...
            <tr class="parent indent0 dotted">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>pivotOffset (po)</h5></td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>pivotOffsetZ (pz)</h5></td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>pivotOffsetY (py)</h5></td>
                <td class="attr_type">doubleLinear</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent1 last">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>pivotOffsetX (px)</h5></td>
                <td class="attr_type">doubleLinear</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>reachRotation (rr)</h5></td>
                <td class="attr_type">double</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">0/1</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>reachTranslation (rt)</h5></td>
                <td class="attr_type">double</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">0/1</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>colorR (clr)</h5></td>
                <td class="attr_type">float</td>
                <td class="attr_value">1.0 (1)</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent1 dotted">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>colorB (clb)</h5></td>
                <td class="attr_type">float</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="child indent1 last">
                ...
                <td class="attr_name" style="text-indent: 4ex;"><h5>colorG (clg)</h5></td>
                <td class="attr_type">float</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>markerLook (mkl)</h5></td>
                <td class="attr_type">enum</td>
                <td class="attr_value">cube</br>hard cross</br>light cross</br>sphere (3)</td>
                <td class="attr_minmax">0/3</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            </tr>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>pinT (pint)</h5></td>
                <td class="attr_type">bool</td>
                <td class="attr_value">False ()</td>
                <td class="attr_minmax">0/1</td>
                <td class="attr_flags">['connectable', 'out']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>auxiliaries (aux)</h5></td>
                <td class="attr_type">message</td>
                <td class="attr_value"> ()</td>
                <td class="attr_minmax">/</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>auxEffector (aeff)</h5></td>
                <td class="attr_type">bool</td>
                <td class="attr_value">False ()</td>
                <td class="attr_minmax">0/1</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable']</td>
            ...
            <tr class="indent0">
                ...
                <td class="attr_name" style="text-indent: 0ex;"><h5>effectorID (ei)</h5></td>
                <td class="attr_type">long</td>
                <td class="attr_value">0.0 ()</td>
                <td class="attr_minmax">/</td>
                <td class="attr_flags">['connectable', 'in', 'out', 'storable', 'hidden']</td>
